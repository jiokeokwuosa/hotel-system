...
if(isset($_POST['day'])){
  ...
  $_SESSION['year']=$_POST['year'];
   ...
   $db->connect();
   $result=$db->select('checkin',array('day'=>$_SESSION['day'],'month'=>$_SESSION['month'],'year'=>$_SESSION['year']));  
    ...
    <div class="row" style="font-size: 17px;">
         <div class="col-md-12">
             <table style="width:100%">
                  ...
                  <h3 class="center color">Daily Room Report for <?php echo $_SESSION['day'].'-'.$_SESSION['month'].'-'.$_SESSION['year'];?></h3>
         </div>      
    </div>
              ...
              <?php
               ...
               while($row=mysqli_fetch_assoc($result)){
                ...
                <tr>
                    ...
                    <td><?php echo date('h:ia',strtotime($date_created));?></td>
                    <?php
