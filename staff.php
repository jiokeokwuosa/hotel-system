   ...
   ?> 
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php  echo"<a onclick='return checkDelete();' href=transact.php?key=$staff_id&action=deleteUser&dest=staff>";?><i class="glyphicon glyphicon-trash" style="color: black;"></i></a> </td>
       <?php
        }
        ?>              
    </tbody> 
