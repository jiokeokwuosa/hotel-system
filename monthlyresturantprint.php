...
if(isset($_POST['month'])){
  ...
  $_SESSION['year']=$_POST['year'];
   ...
   $db->connect();
   $result=$db->select('food_order',array('month'=>$_SESSION['month'],'year'=>$_SESSION['year']));  
    ...
    <div class="row" style="font-size: 17px;">
         <div class="col-md-12">
             <table style="width:100%">
                  ...
                  <h3 class="center color">Monthly Restaurant Report for <?php echo $_SESSION['month'].'/'.$_SESSION['year'];?></h3>
         </div>      
    </div>
