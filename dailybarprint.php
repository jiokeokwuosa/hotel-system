...
if(isset($_POST['day'])){
  ...
  $_SESSION['year']=$_POST['year'];
   ...
   $db->connect();
   $result=$db->select('drink_order',array('day'=>$_SESSION['day'],'month'=>$_SESSION['month'],'year'=>$_SESSION['year']));  
    ...
    <div class="row" style="font-size: 17px;">
         <div class="col-md-12">
             <table style="width:100%">
                  ...
                  <h3 class="center color">Daily Bar Report for <?php echo $_SESSION['day'].'-'.$_SESSION['month'].'-'.$_SESSION['year'];?></h3>
         </div>      
    </div>
