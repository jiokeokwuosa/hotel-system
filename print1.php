...
<?php 
if($status){
       $result1=$db->select('drink_order',array('session_id'=>session_id(),'print_status'=>'false'));
       $numrow=$db->numRow();
       if($numrow==0){
...
<div class="container-fluid">
    ...
    <div class="row" style="font-size: 12px;">
      ...
      <table style="width:25%;">
         ...
         ?>
         <tr>
             <td class="left"><?php echo ucwords(strtolower($db->getDrinkName($drink_id)));?></td>
         ...
         <?php
         $total+=$total_amount;
         $db->update('drink_order',array('print_status'=>'true'),array('order_id'=>$order_id));
          }
